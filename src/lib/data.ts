...
export const SALIDAS: Salida[] = [
  ...
  {
    fecha: '2026-03-15',
    descripcion: 'Viaje Bogotá Royman',
    categoria: 'Viajes',
    moneda: 'COP',
    valor: 200000,
    valorDolar: null,
...
export const BALANCE: Balance = {
  capitales: [
    ...
    {
      concepto: 'Préstamo Lina Bancolombia',
      valor: 37420756,
      nota: 'Con pago de cuota en abril',
    },
    {
      concepto: 'Préstamos Bancolombia',
      valor: 31660947,
      nota: 'Con pago de cuota en abril',
    },
  ],
...
export function totalEntradas() {
  return ENTRADAS.reduce((s, e) => s + (e.moneda === 'COP' ? e.total : 0), 0);
}

export function totalSalidas() {
  return SALIDAS.reduce((s, e) => s + (e.moneda === 'COP' ? e.valor : 0), 0);
}
