  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mono" style={{ color: "#d4a574", fontSize: 11, marginTop: 4 }}>
          Saldo {fmtCOP(summary.currentBalance)}
        </div>
      </div>
      ...
      >
        <UserButton appearance={{ elements: { avatarBox: { height: 30, width: 30 } } }} />
        <div>
